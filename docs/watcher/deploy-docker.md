...
1. Use [rosen command line](https://github.com/rosen-bridge/utils/tree/dev/packages/cli) to compute api key hash:
...
3. Utilizing Swagger on a locally run node. Do not generate hash from a public node.
