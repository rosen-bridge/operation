...
### Table of Contents
- [Monitoring Stack for Wacher and Guard](./docs/monitoring/README.md)
- [Guard](./docs/guard/)
  - [Production Setup](./docs/guard/setup.md)
  - [Environment Variable References](./docs/guard/env-references.md)
  - [Monitoring](./docs/guard/setup.md#monitoring-stack-configuration)
...
- [Watcher](#)
  ...
  - [Environment Variable References](./docs/watcher/env-references.md)
  - [Monitoring](./docs/watcher/deploy-docker.md#monitoring-stack-configuration)
